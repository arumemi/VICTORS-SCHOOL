...
const removeActiveClass = () =>{
   ...
   programsMenu.forEach(program =>{
      program.addEventListener('click', ()  => { 
         removeActiveClass()
         if(program.classList.contains('.mres')){
            ...
            <div class="programDetail__left">
               ...
               <div class="programDetail__images">
                  <div><img src="../images/black girls in b& w background.jpg" alt=""></div>
                   <div><img src="../images/bpp student.jpeg" alt=""></div>
               </div>
            ...
            <div class="programDetail__right">
               <article>
                  ...
                  <div>
                     <h2>$11,000 - $15,000</h2>
                     <P>you will not get full refund after cast is out.</P>
                  </div>
                  <div>
